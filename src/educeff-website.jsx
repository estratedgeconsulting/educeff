...
const FAQS = [
  ...
  { q: "Is there a fee for the initial counseling session?", a: "We offer one free 30-minute counseling session to all registered students. Subsequent sessions are billed based on the service package you choose." },
      ...
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 40 }}>
          <div>
            ...
            {[
              { icon: "📍", label: "Address", val: "IdeastoImpacts ,Pollard farms , Baner, Pune 4110045" },
              { icon: "📞", label: "Phone", val: "+91 9899644633" },
